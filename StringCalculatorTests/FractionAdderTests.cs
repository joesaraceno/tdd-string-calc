...
namespace fractions.Tests
{
  ...
  public class FractionTests
  {
    ...
    {
      Assert.AreEqual("3",
        new Fraction(1).Add(new Fraction(2))
        .ToString()
      );
    }
    ...
    public void ShouldAddAndReduceMixedDenominatorsFractions()
    {
      Assert.AreEqual("7/12",
        new Fraction(1, 4).Add(new Fraction(1, 3))
        .ToString()
      );
    }

    [Test]
    public void ShouldAddAndReduceGreaterThan1Fractions()
    {
      Console.WriteLine(new Fraction(3, 4).Add(new Fraction(3, 4)));
      Assert.AreEqual("1 1/2",
        new Fraction(3, 4).Add(new Fraction(3, 4))
        .ToString()
      );
    }
  }
